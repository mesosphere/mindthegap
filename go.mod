...
require (
	...
	github.com/mesosphere/dkp-cli-runtime/core v0.7.4
	github.com/mholt/archives v0.1.6-0.20260805202448-9bf66b8e091c
...
replace github.com/mholt/archives => ./third_party/github.com/mholt/archives
